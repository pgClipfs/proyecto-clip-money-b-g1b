...
function TransactionComponent_option_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngValue", operacion_r2.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
class TransactionComponent {
    constructor(router, fb, transferencia) {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({});
        this.operaciones = ['transaccion', 'pago servicios', 'pago de tarjeta'];
    }
    ngOnInit() {
        let id = parseInt(localStorage.getItem('id'));
        this.form = this.fb.group({
...
TransactionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TransactionComponent, selectors: [["app-transaction"]], decls: 14, vars: 6, consts: [[1, "container"], [1, "segment"], [1, "register-img"], [1, "page-title"], ["id", "transfer-form", 1, "form", 3, "formGroup", "ngSubmit"], ["formulario", "ngForm"], [1, "form-control"], [3, "ngValue", 4, "ngFor", "ngForOf"], ["formControlName", "cvu", "id", "cvu", "placeholder", "CVU Destino", "ngModel", "", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["formControlName", "monto", "id", "monto", "placeholder", "Monto", "ngModel", "", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange", "change"], ["formControlName", "descripcion", "id", "descripcion", "placeholder", "Descripcion", "ngModel", "", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "btn-primary", "mt-3", "mb-3", 3, "disabled"], [3, "ngValue"]], template: function TransactionComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "h1", 3);
